 ...
 * preferences — is repetitive boilerplate any Lunula app that doesn't run a
 ...
 *     persist (typically a [se.soderbjorn.lunula.core.ThemeSnapshotV2]).
 *
...
/**
 * Builds a [se.soderbjorn.lunula.core.ThemeSnapshotV2] mirror of [state] for
 * persistence.
 *
 * @return the snapshot capturing the current slots + appearance + custom themes.
 */
fun DefaultThemeManagerState.toSnapshotV2(): se.soderbjorn.lunula.core.ThemeSnapshotV2 =
    se.soderbjorn.lunula.core.ThemeSnapshotV2(
 ...
 */
fun DefaultThemeManagerState.applySnapshotV2(snapshot: se.soderbjorn.lunula.core.ThemeSnapshotV2) {
