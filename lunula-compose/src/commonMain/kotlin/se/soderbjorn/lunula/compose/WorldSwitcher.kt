/**
 * Compose world switcher — the mobile counterpart to lunula-web's globe
 * switcher.
 *
 * Greenfield: lunula-compose previously shipped only [LunulaPalette], so
 ...
 * [WorldMenuEntry] list and callbacks rather than depending on lunula-store's
 ...
 * meridian ellipse — matching the lunula-web globe mark. Drawn rather than
 * loaded from an icon font so lunula-compose needs no extended-icons
 * dependency.
 *
