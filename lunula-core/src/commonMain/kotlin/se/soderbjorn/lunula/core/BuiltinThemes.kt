 ...
 *
 * No theme declares a dark/light group any more; `Theme.group` is left at its
 * legacy `null`. Tone is read off the palette ([Theme.isDarkToned]) and the
 * picker's categories are derived the same way ([paletteCategoryOf]).
 */
private fun theme(
...
val builtinThemes: List<Theme> = listOf(
    ...
    theme("Tokyo Midnight", "Indigo", "Calm indigo night with violet & green syntax.",
    ...
    theme("Amber CRT", "Mono", "Warm monochrome amber. Vintage VT terminal.",
    ...
    theme("Synthwave", "Neon", "Neon magenta & cyan. Retro-futurist nights.",
    ...
    theme("Nord Slate", "Arctic", "Cool desaturated slate. Low-contrast & easy.",
    ...
    theme("Solarized Dark", "Precise", "Solarized after dark. Engineered low-glare balance.",
    ...
    theme("Dracula", "Vivid", "The famous vampire palette. Punchy and playful.",
    ...
    theme("Gruvbox Dark", "Retro", "Warm earthy retro groove. Cozy and bold.",
    ...
    theme("Catppuccin Mocha", "Pastel", "Soft pastel mocha. Gentle, modern, cozy.",
    ...
    theme("Carbon", "Mono", "Graphite monochrome. Distraction-free minimalism.",
    ...
    theme("GitHub Dark", "Neutral", "GitHub after dark. Familiar, calm, professional.",
    ...
    theme("Neon Green", "Neon", "Electric neon green on pure black. Old-school overdrive.",
    ...
    theme("Neon Cyan", "Neon", "Electric neon cyan on pure black. Cold and bright.",
    ...
    theme("Monokai Pro", "Vivid", "The classic vivid palette — warm gray with candy syntax.",
    ...
    theme("Deep Sea", "Abyss", "Deep ocean blue-teal. Cool, quiet, submerged.",
    ...
    theme("Ember", "Fire", "Near-black with a molten orange glow. Warm and intense.",
    ...
    theme("Espresso", "Coffee", "Dark roast browns with caramel accents. Cozy and rich.",
    ...
    theme("Ultraviolet", "Violet", "Deep purple night lit by electric violet. Moody neon.",
    ...
    theme("Rosé Pine", "Muted", "Muted rose, gold and foam on a soft plum base.",
    ...
    theme("Crimson", "Wine", "Deep burgundy lit by hot crimson. Bold and vinous.",
    ...
    theme("Forest", "Woodland", "Muted moss and pine. Earthy, calm, organic.",
    ...
    theme("Oxide", "Rust", "Industrial rust and iron. Weathered and warm.",
    ...
    theme("Ice", "Glacier", "Icy pale blue on deep slate. Cold and crisp.",
    ...
    theme("Toxic", "Acid", "Acid lime burning on pure black. Loud and radioactive.",
    ...
    theme("Royal", "Regal", "Deep navy dressed in gold. Stately and rich.",
    ...
    theme("Aurora", "Aurora", "Deep teal night streaked with green, cyan and violet.",
    ...
    theme("Bubblegum", "Candy", "Dark plum with pink and mint candy pop. Playful.",
    ...
    theme("Cobalt Night", "Electric", "Electric blue with a jolt of yellow. High-voltage classic.",
    ...
    theme("Umbra", "OLED", "True-black canvas with cool lilac accents. Pure and OLED-friendly.",
    ...
    theme("Ember Split", "Chrome", "Molten orange on white, wrapped in a near-black warm ember shell.",
    ...
    theme("Solarized Split", "Chrome", "Solarized Light on cream, wrapped in the classic Solarized Dark chrome. The canonical two-tone.",
    ...
    theme("Solarized Light", "Classic", "The cult classic. Precise cream & cyan.",
        "#fdf6e3", "#f6efd8", "#eee8d5", "#ddd6bf", "#586e75", "#93a1a1", "#073642",
        "#268bd2", "#cb4b16", "#dc322f", "#859900", "#5d6b00",
        "#859900", "#2aa198", "#d33682", "#93a1a1", "#268bd2", "#b58900", "#586e75", "#cb4b16"),
    theme("Blossom", "Rose", "Soft rose & mauve. Cozy and gentle.",
    ...
    theme("Cobalt Sky", "Crisp", "Crisp white & cobalt. Bright, high-energy.",
    ...
    theme("Gruvbox Light", "Retro", "Gruvbox by daylight. Warm vintage paper.",
    ...
    theme("GitHub Light", "Neutral", "Clean, familiar developer light. Pure & legible.",
    ...
    theme("Catppuccin Latte", "Pastel", "Latte — the soft pastel light companion.",
    ...
    theme("Frost", "Arctic", "Cool muted daylight. Calm and glare-free.",
    ...
    theme("High Contrast", "A11y", "Maximum legibility. Bold ink on white for clarity.",
    ...
    theme("Sepia", "Vintage", "Warm aged-paper browns. Like ink on an old letter.",
    ...
    theme("Sakura", "Blush", "Saturated cherry-blossom pinks. Sweet and lively.",
    ...
    theme("Citrus", "Zest", "Bright lemon-lime energy. Fresh and punchy.",
    ...
    theme("Lavender Haze", "Violet", "Soft violet daylight. Dreamy and calm.",
    ...
    theme("Seafoam", "Aqua", "Cool teal and mint. Breezy and clean.",
    ...
    theme("Peach", "Coral", "Warm coral and peach. Sunny and inviting.",
    ...
    theme("Marigold", "Gold", "Golden honey warmth. Rich and glowing.",
    ...
    theme("Periwinkle", "Sky", "Soft blue-violet skies. Airy and serene.",
    ...
    theme("Newsprint", "Editorial", "High-contrast ink with a single red byline. Bold and journalistic.",
    ...
    theme("Matcha", "Green", "Earthy green-tea tones. Grounded and mellow.",
    ...
    theme("Terracotta", "Clay", "Warm baked clay and umber. Earthy and grounded.",
    ...
    theme("Sky", "Azure", "Bright azure on clean air. Open and breezy.",
    ...
    theme("Lemonade", "Sunny", "Pale sunlit yellow. Cheerful and bright.",
    ...
    theme("Sage", "Herb", "Muted gray-green herb garden. Quiet and cool.",
    ...
    theme("Flamingo", "Hot", "Vivid coral-pink heat. Energetic and loud.",
    ...
    theme("Ink & Gold", "Luxe", "Warm cream, navy ink and a gilt edge. Understated luxury.",
    ...
    theme("Cotton Candy", "Pastel", "Pastel pink and blue swirl. Soft and playful.",
    ...
    theme("Meadow", "Spring", "Fresh grass and wildflower. Bright and alive.",
    ...
    theme("Slate", "Pro", "Cool neutral blue-gray. Composed and professional.",
    ...
    theme("Heather", "Mauve", "Dusty muted mauve. Gentle and understated.",
    ...
    // ------------------------------ Retro (dark) ------------------------------
    theme("Workbench", "Amiga", "Workbench blue, white and that orange. Kickstart included.",
    ...
    theme("C64", "C64", "38911 BASIC bytes free on VIC-II blue. READY.",
...
/**
 * Names built-ins used to ship under, mapped to what they are called now.
 *
 * A theme's name is its identity key: it is what a slot selection, a favorite
 * and a per-world binding all persist. So renaming one silently unbinds it for
 * every user who had it selected, and they land back on the default with no
 * indication why. This table is what makes a rename a rename rather than a
 * deletion — [builtinTheme] falls through it, so an old name keeps resolving.
 *
 * @see builtinTheme
 */
private val legacyBuiltinNames: Map<String, String> = mapOf(
...
/**
 * Looks up a built-in theme by name, honouring the names built-ins used to
 * ship under ([legacyBuiltinNames]) so a persisted selection survives a rename.
 *
 * @param name the theme name, current or legacy.
 * @return the built-in [Theme], or null if no built-in has that name.
 */
fun builtinTheme(name: String): Theme? =
    builtinByName[name] ?: legacyBuiltinNames[name]?.let { builtinByName[it] }

/**
 * The current name for [name], following a built-in rename if there has been
 * one. Unknown and already-current names are returned unchanged.
 *
 * Callers that persist a theme name (slot selections, favorites) route it
 * through this so a stored legacy name is rewritten the next time it is
 * written back, rather than being carried forever.
 *
 * @param name a theme name, possibly one a built-in used to ship under.
 * @return the name the theme goes by now.
 * @see builtinTheme
 */
fun canonicalThemeName(name: String): String = legacyBuiltinNames[name] ?: name
