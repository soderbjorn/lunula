 ...
 * lunula-demo, and any other Lunula Electron app share the same
 ...
 *   `se.soderbjorn.lunula.web.shell.PersistedLayoutState`)
 ...
 * lunula preload script), or `null` when running in a plain browser.
 *
