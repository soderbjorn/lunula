 ...
 *
 * Why content-agnostic: each lunula app has its own canonical list
 ...
 * lunula app, instead of each hand-writing the same row. The chord is
...
class ToolkitHotkeysModal {
    ...
    private companion object {
        ...
        // sync with lunula.css / toCssVarMap.
