...
package se.soderbjorn.darknessdemo.di
...
interface JsAppGraph {
    ...
    fun providePersister(): Persister =
        ...
        // persist to the OS-conventional shared darkness files. In a plain
        // browser, fall back to namespaced localStorage so the dev-server
        // path still works without any host setup.
        tryElectronIpcPersister() ?: LocalStoragePersister(namespace = "darknessdemo")
}
