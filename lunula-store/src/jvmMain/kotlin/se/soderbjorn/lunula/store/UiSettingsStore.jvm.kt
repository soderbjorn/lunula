 ...
 * (in this process or another Lunula app on the same machine) never
...
/**
 * Resolve the OS-conventional Lunula data directory.
 *
 ...
 * current JVM. The file lives in the same shared user-data directory as the
